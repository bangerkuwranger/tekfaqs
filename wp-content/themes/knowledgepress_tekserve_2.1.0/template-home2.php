...
$boxes_title = get_post_meta( $post->ID, '_boxes_title', true );
$boxes_subtitle = get_post_meta( $post->ID, '_boxes_subtitle', true );
...
$featured_subtitle = get_post_meta( $post->ID, '_featured_subtitle', true );
...
$video_subtitle = get_post_meta( $post->ID, '_video_subtitle', true );
...
<div class="container">
  <?php if ( $boxes ) { ?>
    ...
    ?>
    <div id="boxes">
      <?php if ( $boxes_title || $boxes_subtitle) { ?>
        <div class="home-title">
          <?php
          if ( $boxes_title ) {
            echo '<h2>' . $boxes_title . '</h2>';
          }
          ?>
          <?php
          if ( $boxes_subtitle ) {
            echo '<p>' . $boxes_subtitle . '</p>';
          }
          ?>
        </div>
      <?php } ?>
      <div class="row">
        <div class="<?php echo $box_class; ?>">
          <article class="box box-left">
            <div class="circle">
              <a href="<?php echo $box_link_left; ?>"><span></span><i class="icon-<?php echo $box_icon_left; ?>"></i></a>
            </div>
            <h3><a href="<?php echo $box_link_left; ?>"><?php echo $box_title_left; ?></a></h3>
        ...
        <?php if ( $boxes != 2 ) { ?>
          <div class="col-sm-4">
            <article class="box box-middle">
              ...
              <h3><a href="<?php echo $box_link_middle; ?>"><?php echo $box_title_middle; ?></a></h3>
        ...
        <div class="<?php echo $box_class; ?>">
          <article class="box box-right">
            ...
            <h3><a href="<?php echo $box_link_right; ?>"><?php echo $box_title_right; ?></a></h3>
    ...
    <div class="container">
      <?php if ( $featured_title || $featured_subtitle) { ?>
        <div class="home-title">
          <?php
          if ( $featured_title ) {
            echo '<h2>' . $featured_title . '</h2>';
          }
          ?>
          <?php
          if ( $featured_subtitle ) {
            echo '<p>' . $featured_subtitle . '</p>';
          }
          ?>
        </div>
      <?php } ?>
        ...
        <div class="col-sm-4">
          <div class="box-video-list">
            <h3><?php echo get_the_category_by_id($video_category); ?></h3>
              ...
              wp_reset_postdata();
              echo '</ul>';
              echo '<a class="btn-videos" href="' . get_category_link( $video_category ) . '" title="">' . __('View all videos', PRESSAPPS_TEXT_DOMAIN) . ' <i class="icon-chevron-right"></i></a>';
              ?>
          </div>  
        </div>
      </div>
