			...
			switch ( $field['type'] ) {
				...
				case 'post_select':
					...
					foreach ( $galleries_arr as $gallery ) {
						$name = empty($gallery->post_title) ? 'Unnamed' : $gallery->post_title;
						if ($gallery->ID == $meta) {
							echo '<option value="' . $gallery->ID . '" selected>' . $name . '</option>';
						} else {
							echo '<option value="' . $gallery->ID . '">' . $name . '</option>';
						}
					}
					echo '</select>';
					echo '<span class="cmb_metabox_description">', $field['desc'], '</span>';
				...
				case 'category_select':
					...
					foreach ( $categories as $category ) {
						$name = empty($category->cat_name) ? 'Unnamed' : $category->cat_name;
						if ($category->cat_ID == $meta) {
							echo '<option value="' . $category->cat_ID . '" selected>' . $name . '</option>';
						} else {
							echo '<option value="' . $category->cat_ID . '">' . $name . '</option>';
						}
					}
					echo '</select>';
					echo '<span class="cmb_metabox_description">', $field['desc'], '</span>';
