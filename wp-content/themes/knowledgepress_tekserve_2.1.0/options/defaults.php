    ...
    class Redux_Options {
        ...
        */
        function __construct($sections = array(), $args = array(), $extra_tabs = array()) {    
            ...
            $defaults['help_sidebar'] = __('Help', Redux_TEXT_DOMAIN);
        ...
        function _options_page_html() {
            ...
            foreach($this->sections as $k => $section) {
				if($this->args['icon_type'] == 'image' || (isset($section['icon_type']) && $section['icon_type'] == 'image')) {
					...
					$icon = (!isset($section['icon'])) ? '<i class="icon-fixed-width icon-cog' . $icon_class . '"></i> ' : '<i class="icon-fixed-width icon-' . $section['icon'] . $icon_class . '"></i> ';
				} else {
					$icon_class = (!isset($section['icon_class'])) ? '' : ' ' . $section['icon_class'];
					$icon = (!isset($section['icon'])) ? '<i class="icon-fixed-width icon-cog' . $icon_class . '"></i> ' : '<i class="icon-fixed-width icon-' . $section['icon'] . $icon_class . '"></i> ';
				}
            ...
            if(true === $this->args['show_import_export']) {
				...
				if( isset( $this->args['import_icon_type'] ) && $this->args['import_icon_type'] == 'image' ) {
					...
					$icon = (!isset($this->args['import_icon'])) ? '<i class="icon-fixed-width icon-refresh' . $icon_class . '"></i>' : '<i class="icon-fixed-width icon-' . $this->args['import_icon'] . $icon_class . '"></i> ';
				}
            ...
            if(is_array($this->extra_tabs)) {
				foreach($this->extra_tabs as $k => $tab) {
					if($this->args['icon_type'] == 'image' || (isset($tab['icon_type']) && $tab['icon_type'] == 'image')) {
    	                ...
    	                $icon = (!isset($tab['icon'])) ? '<i class="icon-fixed-width icon-cog' . $icon_class . '"></i> ' : '<i class="icon-fixed-width icon-' . $tab['icon'] . $icon_class . '"></i> ';
					} else {
						$icon_class = (!isset($tab['icon_class'])) ? '' : ' ' . $tab['icon_class'];
    	                $icon = (!isset($tab['icon'])) ? '<i class="icon-fixed-width icon-cog' . $icon_class . '"></i> ' : '<i class="icon-fixed-width icon-' . $tab['icon'] . $icon_class . '"></i> ';
					}
            ...
            if(true === $this->args['dev_mode']) {
				...
				if( isset( $this->args['dev_mode_icon_type'] ) && $this->args['import_icon_type'] == 'image' ) {
					...
					$icon = (!isset($this->args['dev_mode_icon'])) ? '<i class="icon-fixed-width icon-info-sign' . $icon_class . '"></i>' : '<i class="icon-fixed-width icon-' . $this->args['dev_mode_icon'] . $icon_class . '"></i> ';
				}
