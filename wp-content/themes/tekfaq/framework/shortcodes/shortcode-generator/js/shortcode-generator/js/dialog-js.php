<?php
	...
	$woo_framework_url = get_stylesheet_directory_uri() . '/framework/shortcodes/shortcode-generator/';
...
var wooDialogHelper = {
    ...
    createTextAreaControl: function (a, b, c) {
        ...
        jQuery( '<textarea>').attr( "id", g).attr( "name", g).attr( "rows", 6).attr( "cols", 54).addClass(f).addClass(d).addClass( 'txt input-textarea').addClass(c ? "woo-focus-here" : "").appendTo(b);
