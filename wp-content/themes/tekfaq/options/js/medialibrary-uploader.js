...
/*
/* Modifications for Guerilla Framework.
/*-----------------------------------------------------------------------------------*/

(function ($) {

  guerillaframeworkMLU = {
...
/*-----------------------------------------------------------------------------------*/
  ...
  }; // End guerillaframeworkMLU Object // Don't remove this, or the sky will fall on your head.

/*-----------------------------------------------------------------------------------*/
/* Execute the above methods in the guerillaframeworkMLU object.
/*-----------------------------------------------------------------------------------*/
  
	$(document).ready(function () {

		guerillaframeworkMLU.removeFile();
		guerillaframeworkMLU.recreateFileField();
		guerillaframeworkMLU.mediaUpload();
