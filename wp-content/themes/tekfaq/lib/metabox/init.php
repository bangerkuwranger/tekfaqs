...
function cmb_scripts( $hook ) {
  	if ( $hook == 'post.php' || $hook == 'post-new.php' || $hook == 'page-new.php' || $hook == 'page.php' ) {
		wp_register_script( 'cmb-timepicker', get_stylesheet_directory_uri().'/lib/metabox/js/jquery.timePicker.min.js' );
		wp_register_script( 'cmb-scripts', get_stylesheet_directory_uri().'/lib/metabox/js/cmb.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-datepicker', 'media-upload', 'thickbox', 'farbtastic' ) );
		wp_enqueue_script( 'cmb-timepicker' );
		wp_enqueue_script( 'cmb-scripts' );
		wp_register_style( 'cmb-styles', get_stylesheet_directory_uri().'/lib/metabox/style.css', array( 'thickbox', 'farbtastic' ) );
